...
export const dataVerifications = pgTable('data_verifications',{
id : uuid('id').defaultRandom().primaryKey(),
sourceId : uuid('source_id').notNull().references(()=>dataSources.id,{onDelete:'restrict'}),
