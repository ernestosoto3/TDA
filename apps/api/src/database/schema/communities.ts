...
index('communities_linked_sport_id_idx').on(
communities.linkedSportId,
),

index('communities_linked_league_id_idx').on(
communities.linkedLeagueId,
),

index('communities_linked_team_id_idx').on(
communities.linkedTeamId,
),
],
)