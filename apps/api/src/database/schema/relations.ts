...
export const moderatorCommunityScopesRelations = relations(
...
export const moderationEscalationsRelations = relations(
...
export const policyAcceptancesRelations = relations(
policyAcceptances,
({one})=>({
user : one(users,{
